...
签名头、Profile 数字签名、包名、证书、调试设备绑定以及 HAP 内嵌 BIN 一致性。当前产物为
`~/Downloads/WatchBuddy-0.1.0-debug-signed.hap`，6720326 字节，SHA-256 为
...
当前一加 13T 上的应用调测助手已经在 Lite Wearable 页面识别出已配对的 GT 6 Pro，证明这台手机
